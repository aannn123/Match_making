    ...
    public function change()
    {
         $poligami = $this->table('poligami');
             $poligami->addColumn('user_id', 'integer')
                  ...
                  ->addColumn('alasan_poligami', 'text', ['null' => true])
                  ->addColumn('kondisi_istri', 'enum', ['values' =>  ['belum mengizinkan', 'sudah mengizinkan', 'mendukung dan membantu mencarikan', 'belum punya istri'], 'null' => true])
